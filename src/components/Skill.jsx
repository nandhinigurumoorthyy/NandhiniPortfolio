...
import c2cIcon from "../assets/c2cIcon.png";
...
const skillItem = [
  ...
  { imgSrc: githubIcon, label: "GitHub", desc: "Version Control" },
  { imgSrc: apiIcon, label: "RESTful APIs", desc: "Data Communication" },
  { imgSrc: postmanIcon, label: "Postman API", desc: "API Testing Tool" },
  { imgSrc: c2cIcon, label: "C2C", desc: "eLearning Platform" },
  { imgSrc: jwtIcon, label: "JWT", desc: "Authentication" },
  { imgSrc: jsonIcon, label: "JSON", desc: "Data Format" },
];
...
const Skill = () => {
  return (
    <section className="section mb-4 px-4 mx-auto lg:px-8 xl:max-w-6xl">
      ...
      <p className="mt-3 mb-8 md:max-w-[70ch] lg:max-w-full text-2xl">
        Unlocking creativity and efficiency with powerful technologies to build
